...
{
    public partial class FixingDescription : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourDuration = table.Column<DateTime>(type: "datetime2", nullable: false),
                    createTourTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourTime", x => x.TourID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InPersonTourSchedule", x => x.RequestID);
                    table.ForeignKey(
                        name: "FK_InPersonTourSchedule_TourTime_TourID",
                        column: x => x.TourID,
                        principalTable: "TourTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InPersonTourSchedule_TourID",
                table: "InPersonTourSchedule",
                column: "TourID");
        }
